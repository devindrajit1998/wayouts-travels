        ...
        const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
            ...
            try {
                ...
                if (!snap.empty) {
                    ...
                    // Provide personalized welcome package if no bookings yet
                    setCustomerBookings([
                        {
                            id: 'WY-WELCOME',
                            bookingId: 'WY-WELCOME',
                            tour: 'Kashmir & Ladakh Paradise Escape',
                            departureDate: '15 Sep 2026',
                            travelers: '2 Adults',
                            amount: '₹49,998',
                            status: 'Draft / Inquired',
                            paymentStatus: 'Pending Payment',
                            specialRequests: 'Upper deck houseboat suite on Dal Lake'
                        }
                    ]);
                }
            } catch (err) {
                                                ...
                                                <div key={i} style={{ padding: '20px', borderRadius: '16px', background: '#f8fafc', border: '1px solid #e2e8f0', marginBottom: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                                    ...
                                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '12px', paddingTop: '8px', borderTop: '1px solid #e2e8f0' }}>
                                                        <div>
                                                            ...
                                                            <strong style={{ color: '#09204c', fontSize: '13px' }}>{b.departureDate || '15 Sep 2026'}</strong>
                                                        </div>
                                                        <div>
                                                            <small style={{ color: '#64748b', fontSize: '11px', display: 'block', textTransform: 'uppercase' }}>Travelers</small>
                                                            <strong style={{ color: '#09204c', fontSize: '13px' }}>{b.travelers || '2 Adults'}</strong>
                                                        </div>
                                                        <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <strong style={{ color: '#09204c', fontSize: '13px' }}>{b.paymentStatus || 'Paid'}</strong>
                                                        </div>
                                                    </div>
